            ...
            <li className="group relative" key={index}>
              {
                menuItem.subItem
                  ? (
                    <span className={`transition-all duration-300 text-black hover:text-secondary capitalize font-semibold cursor-pointer group flex items-center`}>
                      <span className="mr-2">
                        {menuItem.label}
                      </span>
                    ...
                    <a
                      href={menuItem.url}
                      className={`text-black transition-all duration-300 hover:text-secondary capitalize font-semibold`}
                    >
                      {menuItem.label}
                    </a>
                  )}

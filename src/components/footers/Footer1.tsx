...
const Footer1: React.FC<Footer1Props> = ({ dataGlobal }) => {
    ...
    return (
        <div>
            <div className="w-full h-full overflow-hidden relative bg-gray-800"
            >
                            ...
                            !onePages && (
                                <ul className="md:flex gap-3 hidden">
                                    <li className="text-white font-semibold text-center md:text-start">
                                        <a href="/" className="hover:text-primary transition-all duration-300 ease-in-out">Home</a>
                                    </li>
                                    <li className="text-white font-semibold text-center md:text-start">
                                        <a href="/about" className="hover:text-primary transition-all duration-300 ease-in-out">About</a>
                                    </li>
                                    {
                                        blogPages && (
                                            <li className="text-white font-semibold text-center md:text-start">
                                    ...
                                    <li className="text-white font-semibold text-center md:text-start">
                                        <a href="/contact" className="hover:text-primary transition-all duration-300 ease-in-out">Contact</a>
                                    </li>
                                </ul>
                            )
                        }

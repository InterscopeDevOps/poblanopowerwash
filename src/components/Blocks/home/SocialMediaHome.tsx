...
const SocialMediaHome: React.FC<SocialMediaHomeProps> = ({ dataGlobal }) => {
    ...
    return (
        <div className="pb-10 bg-white p-10 w-4/5 mx-auto rounded-2xl -mt-16 z-[99] relative ">

            <div className="pb-5">
                <h2 className="text-5xl font-bold capitalize text-primary text-center">Find Us on</h2>
            </div>
            ...
            <div className=" w-3/4 mx-auto flex flex-col md:flex-row justify-center items-center md:pb-0">
                <a
